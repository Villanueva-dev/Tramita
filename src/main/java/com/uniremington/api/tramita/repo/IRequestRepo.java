...
public interface IRequestRepo extends JpaRepository<Request, UUID> {
    ...
    * trámite (FR-011): cédula o código institucional por igualdad exacta, o fragmento del nombre
    ...
    * el endpoint devuelve el padrón completo —nombre, cédula y código institucional de cada
