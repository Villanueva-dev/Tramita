 ...
 * minimización del §III leída como la lee {@code Request}: un dato de contacto se
 * expone cuando tiene quién lo use. La 008 es ese consumidor —la Coordinación arma con
 ...
 * ({@code RequestSummaryResponse}, {@code InboxEntryResponse}), que listan sin criterio.
 *
