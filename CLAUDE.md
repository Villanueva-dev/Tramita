...
- `.specify/memory/constitution.md` **está ratificada (v1.0.0, 2026-07-02) y va por la v2.2.0 (última enmienda: 2026-08-14)** vía `/speckit-constitution`: 5 principios (KISS+YAGNI · **arquitectura por capas** · seguridad por defecto **+ minimización de datos personales** · decisiones trazables · testing pragmático) + secciones de restricciones tecnológicas, idioma y proceso (Scrum, sprints de 2 semanas). Tres enmiendas hasta hoy:
