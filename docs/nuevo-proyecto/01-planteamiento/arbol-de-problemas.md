...
| **SP5** | C4 | La coordinación carece de una vista consolidada de pendientes y el estudiante no puede consultar el estado de su solicitud. | **Desarrollar** la bandeja de trabajo de la **coordinación** (solicitudes pendientes de su acción y su SLA) y la **vista de consulta del estudiante** (estado y finalización). Los aprobadores externos no son usuarios del sistema, por lo que no tienen bandeja propia. | S3 |
| **SP6** | C1, C5, C7 | No hay historial accesible ni para el estudiante ni para auditoría. | **Construir** un timeline de auditoría inmutable por solicitud: **profundo para la coordinación y la auditoría** (todas las transiciones, fechadas y por autor) y **mínimo para el estudiante** (estado actual y finalización). | S1 |
| **SP7** | C7 | Los canales de comunicación son cuatro y descoordinados. | **Integrar** notificaciones automáticas (correo en MVP; otros canales como hipótesis posterior) disparadas por las **transiciones registradas en el sistema** (subproducto de las acciones de la coordinación), no por eventos externos que el sistema observe. | S3 |
...
- **Consulta básica del estado de sus propias solicitudes** por el estudiante (rol de consulta; borrador de constitución `draft-principios.md` § Roles). La **notificación por correo al finalizar** corresponde a un tema del tramo **no transcrito** de la Entrevista 3 (P23); su contenido **no está verificado** y queda por confirmar al recuperar ese tramo (el canal transcrito con el estudiante es WhatsApp); coherente con la nota de «vistas pendientes» más abajo.
...
> **Nota — vistas pendientes de definir**: el diseño concreto de las vistas que la coordinación y el estudiante desean (qué información, con qué granularidad) corresponde a las preguntas 21–23 de la guía, que quedaron en el tramo **no transcrito** de la Entrevista 3. **No se asumen**: se especificarán al recuperar ese tramo o en la próxima interacción. El alcance afirmado arriba se limita a lo confirmado — trazabilidad profunda del lado de administración y consulta básica de estado por el estudiante (la notificación por correo al finalizar queda por confirmar, ver arriba).
...
| **Opacidad** | Capacidad de reconstruir el histórico de una solicitud en menos de 1 minuto. | Imposible sin leer hilos de correo. | Ganancia transversal, **principal en novedad de notas**: timeline profundo para la coordinación; estado y finalización para el estudiante. |
...
- **Normativa de los dos trámites** (reglamento estudiantil / PEI / políticas) — la coordinación la buscará la próxima semana.
- **Re-transcripción del tramo 30–41 min de la Entrevista 3** (Bloques VII–IX, preguntas 21–35: vista del estudiante, volumetría, calendario, hosting, protección de datos).
- **Vistas concretas que coordinación y estudiante desean** (preguntas 21–23) — hoy **no asumidas**.
