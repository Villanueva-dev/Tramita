...
| **SP7** | C7 | Los canales de comunicación son cuatro y descoordinados. | **Ofrecer** a la Coordinación un **aviso al estudiante solo al completarse** el trámite —cualquier estado que la configuración marque como final, rechazo incluido—, como **dos acciones manuales** desde el detalle de la solicitud: un correo prellenado (`mailto:`), que es lo que ella pidió (Sesión 2 parte B, P22–P23), y un chat de WhatsApp (`wa.me`), decisión del equipo. El sistema **no envía nada ni registra «avisado»**: expone el origen, el correo y el teléfono declarados, y la Coordinación decide. Las transiciones intermedias generan únicamente entradas en el **timeline interno** (coordinación y auditoría). *Enmendado el 2026-09-24 (feature 008): esta fila describía un «puerto de notificación» con correo institucional automático y chat de plantilla como respaldo, atado a SMTP (Q34). Sin SMTP institucional no hay correo oficial —y la P34 nunca llegó a formularse—, así que el MVP no envía, y con eso desaparecen el puerto, el adaptador y el riesgo.* | S3 | [#13](https://github.com/Villanueva-dev/Tramita/issues/13) |
